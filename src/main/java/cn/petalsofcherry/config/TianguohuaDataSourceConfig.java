 ...
 */
@Configuration
@ConfigurationProperties("spring.datasource.tianguohua")
@MapperScan(basePackages = "cn.petalsofcherry.mapper.tianguohua")
public class TianguohuaDataSourceConfig {
